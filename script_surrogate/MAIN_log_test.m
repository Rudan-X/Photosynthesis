...
A=[A1, zeros(size(A1,1),nvars-size(A1,2))];
b=b1;
...
options = optimoptions('surrogateopt','MaxFunctionEvaluations',10,'PlotFcn','surrogateoptplot','UseParallel',true,'InitialPoints',init_sol,'MinSampleDistance',1);
