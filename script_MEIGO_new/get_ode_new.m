function [dxdt]=get_ode_new(t,sim_x,kinetic_param,model_d,cond)
...
% dxdt_full(39)=sum(x_full([27:35,39]))-1; % 
% dxdt_full(46)=sum(x_full([40,41,43,46]))-1;
% dxdt_full(48)=sum(x_full([47,48]))-model_d.metsub(47); % PC
% dxdt_full(52)=sum(x_full(49:52))-1; % cytochrome

% dxdt_full(54)=sum(x_full([24,26,53,54]))-model_d.metsub(24);

dxdt_full(59)=sum(x_full([55,56,59]))-1;
