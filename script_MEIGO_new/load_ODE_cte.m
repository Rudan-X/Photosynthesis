...
metacte.names=string({'Pi[s]','Pi[c]','CO2[s]', 'O2[s]','NADp','NADH', 'O2[l]', 'O2[c]','CO2[c]'});
% The amount of the corresponding compounds given in miliM, then converted
% to M
metacte.content=zeros(length(metacte.names),2);

% day concentration
metacte.content(:,1)=[2; 31;  0.33; 0.245; 0.6; 0.005; 0.245; 0.245; 0.33; ]*(1e-3);

% dark concentration
metacte.content(:,2)=[5; 17;  0.33; 0.245; 1;   0.007; 0.245; 0.245; 0.33; ]*(1e-3);
